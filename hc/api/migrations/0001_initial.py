# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-01-05 01:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[(b'email', b'Email'), (b'aft', b'AfricasTalking'), (b'webhook', b'Webhook'), (b'hipchat', b'HipChat'), (b'slack', b'Slack'), (b'pd', b'PagerDuty'), (b'po', b'Pushover'), (b'victorops', b'VictorOps')], max_length=20)),
                ('username', models.CharField(blank=True, help_text=b'AfricasTalking username', max_length=20)),
                ('api_key', models.CharField(blank=True, default=b'', max_length=80, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, error_messages={b'blank': b'Please make sure name is string!'}, max_length=100)),
                ...
                ('status', models.CharField(choices=[(b'up', b'Up'), (b'down', b'Down'), (b'new', b'New'), (b'paused', b'Paused'), (b'fast', b'Fast')], default=b'new', max_length=6)),
                ('interval', models.DurationField(default=datetime.timedelta(0, 3600))),
