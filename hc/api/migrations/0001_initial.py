# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-01-07 08:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('email', 'Email'), ('aft', 'AfricasTalking'), ('webhook', 'Webhook'), ('hipchat', 'HipChat'), ('slack', 'Slack'), ('pd', 'PagerDuty'), ('po', 'Pushover'), ('victorops', 'VictorOps')], max_length=20)),
                ('username', models.CharField(blank=True, help_text='AfricasTalking username', max_length=20)),
                ('api_key', models.CharField(blank=True, default='', max_length=80, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, error_messages={'blank': 'Please make sure name is string!'}, max_length=100)),
                ...
                ('status', models.CharField(choices=[('up', 'Up'), ('down', 'Down'), ('new', 'New'), ('paused', 'Paused'), ('fast', 'Fast')], default='new', max_length=6)),
                ...
                ('user_emails', models.CharField(blank=True, max_length=700)),
